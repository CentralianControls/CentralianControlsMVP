  ...
  if (!brand) {
    return (
      <main className="min-h-screen bg-white px-6 py-32 text-center">
        <h1 className="text-5xl font-bold text-[#1a1d23]">Brand Not Found</h1>
        <Link
          to="/brands"
        ...
        <div className="relative mx-auto max-w-7xl lg:px-8">
          ...
          >
            ...
            >
              ...
              <p className="mt-3 text-4xl font-bold">{brand.name}</p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl font-bold leading-tight text-[#1a1d23]">
              Industrial technology supported by Centralian Controls.
            </h2>

            <div className="mt-6 space-y-5 text-lg leading-relaxed text-gray-600">
              {brand.overview.map((paragraph) => (
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-[#1a1d23]">
              Local support for trusted global technology.
            </h2>
            <p className="mt-6 text-lg leading-relaxed text-gray-600">
              Centralian Controls combines product knowledge, application
              guidance and practical industrial experience to help customers
              choose suitable solutions for Australian operating environments.
            </p>
          </motion.div>
